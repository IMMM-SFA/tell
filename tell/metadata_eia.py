...
def metadata_eia(numbers):
    ...
    :return: ba_long_name: str -> BA long name
     """
    results = []
    ba_short_name = ""
    ba_long_name = ""
    for eia_ba_number in numbers:
        ...
        elif eia_ba_number == 317:    ba_short_name = 'YAD';  ba_long_name = 'Alcoa Power Generating Inc. - Yadkin Division'
        ...
        elif eia_ba_number == 11249:  ba_short_name = 'LGEE'; ba_long_name = 'Louisville Gas & Electric Company and Kentucky Utilities'
        ...
        elif eia_ba_number == 16534:  ba_short_name = 'BANC'; ba_long_name = 'Balancing Authority of Northern California'
        ...
        elif eia_ba_number == 18195:  ba_short_name = 'SOCO'; ba_long_name = 'Southern Company Services Inc. - Transmission'
        elif eia_ba_number == 18429:  ba_short_name = 'TPWR'; ba_long_name = 'City of Tacoma Department of Public Utilities Light Division'
        ...
        elif eia_ba_number == 19610:  ba_short_name = 'WAUW'; ba_long_name = 'Western Area Power Administration - UGP West'
        ...
        elif eia_ba_number == 25471:  ba_short_name = 'WALC'; ba_long_name = 'Western Area Power Administration - Desert Southwest Region'
        elif eia_ba_number == 28502:  ba_short_name = 'WAUE'; ba_long_name = 'Western Area Power Administration - UGP East'
        elif eia_ba_number == 28503:  ba_short_name = 'WACM'; ba_long_name = 'Western Area Power Administration - Rocky Mountain Region'
        ...
        elif eia_ba_number == 56669:  ba_short_name = 'MISO'; ba_long_name = 'Midcontinent Independent Transmission System Operator Inc.'
